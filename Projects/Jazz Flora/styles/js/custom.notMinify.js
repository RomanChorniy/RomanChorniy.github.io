...
$(document).ready(function () {
  $('.telephoneIcon').on('click', function () {
    if (!$('.telephoneList').hasClass('telephoneList__mobile'))
      $('.telephoneList').addClass('telephoneList__mobile')
    else $('.telephoneList').removeClass('telephoneList__mobile')
  })
